...
public class AddDataFragment extends Fragment implements View.OnClickListener, BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    private LinearLayout btn_mengandung_pengembangbiakan,btn_inseminasi_pengembangbiakan,
            ...
            btn_produksisusu_pengembangbiakan,btn_batasproduksisusu_pengembangbiakan,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_produksisusu_pengembangbiakan = (LinearLayout)view.findViewById(R.id.btn_produksisusu_pengembangbiakan);
        btn_produksisusu_pengembangbiakan.setOnClickListener(this);

        btn_batasproduksisusu_pengembangbiakan = (LinearLayout)view.findViewById(R.id.btn_batasproduksisusu_pengembangbiakan);
        btn_batasproduksisusu_pengembangbiakan.setOnClickListener(this);
    ...
    public void onClick(View v)
    {
        ...
        switch (id){
            ...
            case R.id.btn_produksisusu_pengembangbiakan :
                Log.d("ID",String.valueOf(id));
                i = new Intent(getActivity(), AddProduksiSusu.class);
                startActivity(i);
                break;
            case R.id.btn_batasproduksisusu_pengembangbiakan :
                Log.d("ID",String.valueOf(id));
                i = new Intent(getActivity(), AddBatasProduksi.class);
                startActivity(i);
                break;
